// --- START OF FILE auth_v3.js ---
(() => {
    "use strict";
    console.log("[OpenList] Turnstile Mode 启动...");
    ...
    const icons = {
        ...
        manage: 'data:image/svg+xml;base64,',
    ...
    let tId;
    function mount() {
        let box = document.getElementById('auth-link-container');
        // 如果自定义头部里没有，就自己创建一个兜底
        if (!box) { 
